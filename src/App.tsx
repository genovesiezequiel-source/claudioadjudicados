...
import { Menu, X, ChevronRight, Star, Calendar, Gauge, CheckCircle2, MessageCircle, ShieldCheck, Clock, ThumbsUp } from 'lucide-react';
...
export default function App() {
  ...
  const handleSellSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hola, quiero cotizar mi plan para venderlo.%0A%0A*Nombre:* ${sellForm.nombre}%0A*Compañía:* ${sellForm.compania}%0A*Vehículo:* ${sellForm.modelo}%0A*Cuotas Pagas:* ${sellForm.cuotasPagas}%0A*Mensaje:* ${sellForm.mensaje}`;
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex-shrink-0 flex items-center">
              <a href="#" className="flex items-center gap-2">
                <img
                  src="https://i.imgur.com/uUofYeD.png"
                  alt="Claudio Adjudicados"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center">
              <a href="https://wa.me/5491134563999?text=Hola, quiero consultar por los planes adjudicados disponibles." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-4 sm:px-8 text-base sm:text-lg font-bold text-white bg-red-600 rounded-md hover:bg-red-700 transition-all duration-200 w-full sm:w-auto text-center">
                <MessageCircle className="mr-2 flex-shrink-0" size={24} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                  En <strong className="text-gray-900">Claudio Adjudicados</strong> somos especialistas con más de 10 años de trayectoria en el mercado automotriz argentino. Nos destacamos por brindar soluciones rápidas, seguras y transparentes en la compra y venta de planes de ahorro y vehículos prendados.
                </p>
              ...
              <div className="relative h-[500px] rounded-xl overflow-hidden shadow-xl flex items-center justify-center bg-white p-8">
                <img src="https://i.imgur.com/uUofYeD.png" alt="Claudio Adjudicados Logo" className="w-full h-auto max-h-full object-contain" referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
        </section>
      ...
      <footer id="contacto" className="bg-gray-900 text-white pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            <div>
              <img src="https://i.imgur.com/uUofYeD.png" alt="Claudio Adjudicados" className="h-16 bg-white p-2 rounded-md mb-6" referrerPolicy="no-referrer" />
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
            <p>&copy; {new Date().getFullYear()} Claudio Adjudicados. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
